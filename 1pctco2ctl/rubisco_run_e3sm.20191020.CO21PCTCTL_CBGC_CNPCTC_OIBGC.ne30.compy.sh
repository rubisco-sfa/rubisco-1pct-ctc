...
set job_name       = CO21PCTCTL_RUBISCO_CNPCTC1850_OIBGC
set compset        = BGCEXP_CNTL_CNPRDCTC_1850
...
set restart_files_dir = /compyfs/inputdata/e3sm_init/20181130_BCRC_1850SPINUP_OIBGC.ne30_oECv3.edison/0370-01-01-00000
### REMEMBER: you still need to change the MPAS0/seaice restart dates in the "Run Configuration Options" section, below (starting around line 1390)
...
#  git clone git://github.com/E3SM-Project/ACME-Hooks.git .git/hooks      # checkout read-only.
...
cat <<EOF >> user_nl_clm
 ...
 hist_fincl1 = 'TOTPRODC','LEAFC_STORAGE','LEAFC_XFER','FROOTC_STORAGE','FROOTC_XFER','LIVESTEMC_STORAGE','LIVESTEMC_XFER',
               ...
               'DEADCROOTP_XFER_TO_DEADCROOTP','DWT_PROD100N_GAIN','DWT_PROD10N_GAIN','DWT_PROD100P_GAIN','DWT_PROD10P_GAIN','WOOD_HARVESTP','DWT_PLOSS','DWT_NLOSS'
...
sed -i 's%/compyfs/inputdata/ocn/mpas-o/oEC60to30v3/mpaso.rst.BCRC_CNPECACNT_1850_anvil02.0066-01-01.no-xtime.180418.nc%mpaso.rst.0370-01-01_00000.nc%g' streams.ocean
...
awk 'NR==1,/mpaso.rst.0370-01-01_00000.nc/{sub(/mpaso.rst.0370-01-01_00000.nc/, "init.mpaso.rst.0370-01-01.nc")} 1' streams.ocean.tmp > streams.ocean
...
awk 'NR==1,/\/compyfs\/inputdata\/ice\/mpas-cice\/oEC60to30v3\/mpascice.rst.BCRC_CNPECACNT_1850_anvil02.0066-01-01.no-xtime.180418.nc/{sub(/\/compyfs\/inputdata\/ice\/mpas-cice\/oEC60to30v3\/mpascice.rst.BCRC_CNPECACNT_1850_anvil02.0066-01-01.no-xtime.180418.nc/, "mpascice.rst.0370-01-01_00000.nc")} 1' streams.seaice.tmp > streams.seaice.tmp2
awk 'NR==1,/\/compyfs\/inputdata\/ice\/mpas-cice\/oEC60to30v3\/mpascice.rst.BCRC_CNPECACNT_1850_anvil02.0066-01-01.no-xtime.180418.nc/{sub(/\/compyfs\/inputdata\/ice\/mpas-cice\/oEC60to30v3\/mpascice.rst.BCRC_CNPECACNT_1850_anvil02.0066-01-01.no-xtime.180418.nc/, "mpascice.rst.0370-01-01_00000.nc")} 1' streams.seaice.tmp2 > streams.seaice
